...
function TradingViewChartComponent({ pair, direction, existingImage }: TradingViewChartProps) {
  ...
  const openInTradingView = () => {
    ...
    toast.info('Use TradingView\'s screenshot feature to save your chart');
  };
    ...
    <div className="space-y-4">
      ...
      <div className="p-3 rounded-lg bg-muted/30 border border-border/30">
        <p className="text-xs text-muted-foreground">
          ...
          Click "Open Full Chart" to access all drawing tools and save screenshots.
        </p>
      </div>
